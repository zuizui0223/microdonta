...
from eco_genetic_criticality.multipatch_criticality_dynamics import DynamicsParameters, simulate
...
from examples.eco_genetic_criticality.multipatch_phase_diagram_pilot import (
    pilot_spec,
    render_markdown,
)
from examples.eco_genetic_criticality.multipatch_h_alpha_lead_phase_boundary import (
...
def test_experiment_layer_does_not_reinterpret_theorem_claims() -> None:
    import eco_genetic_criticality.multipatch_criticality_experiments as experiments
