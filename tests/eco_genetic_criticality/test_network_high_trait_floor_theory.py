...
from eco_genetic_criticality.multipatch_criticality_dynamics import DynamicsParameters
from eco_genetic_criticality.network_high_trait_floor_theory import (
