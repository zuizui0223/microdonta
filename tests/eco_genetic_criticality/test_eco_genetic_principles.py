...
from eco_genetic_criticality.eco_genetic_principles import (
...
def test_hypothesis_program_keeps_central_hypotheses_outside_theorem_claims():
    text = Path("docs/eco_genetic_criticality/eco_genetic_hypothesis_program.md").read_text(encoding="utf-8")
