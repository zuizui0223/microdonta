...
def test_xor_requires_horizon_two_even_though_every_singleton_is_zero():
...
def test_direct_measurement_is_already_actionable_at_horizon_one():
    ...
    assert profile.first_positive_horizon == 1
...
def test_jointly_uninformative_candidate_vector_has_zero_at_every_horizon():
    ...
    assert profile.first_positive_horizon is None
...
def test_normalization_does_not_change_first_positive_horizon():
    states = (0, 1, 1, 0)
    q1 = (0, 0, 1, 1)
    q2 = (0, 1, 0, 1)
