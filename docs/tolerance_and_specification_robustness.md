...
> **Nested admissible regions can reverse the information ranking of candidate observations; stability of the next-observation recommendation should therefore be reported over a predeclared sensitivity set when the specification is uncertain.**
