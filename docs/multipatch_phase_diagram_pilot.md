...
```bash
python examples/multipatch_phase_diagram_pilot.py
```
...
| equal_isolated | 0.8 | 3.0 | 0.55 | 0.750 | 0.057 | 0.064 | 0.157 |
| equal_migrating | 0.8 | 3.0 | 0.55 | 0.625 | 0.087 | 0.099 | 0.118 |
| one_large | 0.8 | 4.5 | 0.75 | 1.000 | 0.102 | 0.102 | 0.000 |
| equal_isolated | 0.8 | 4.5 | 0.75 | 0.250 | 0.029 | 0.052 | 0.331 |
| equal_migrating | 0.8 | 4.5 | 0.75 | 0.125 | 0.018 | 0.027 | 0.232 |
...
| equal_migrating | 1.2 | 4.5 | 0.75 | 0.250 | 0.039 | 0.044 | 0.087 |
...
36 of 54 pilot rows had at least one nonzero genetic/allele lead probability.
