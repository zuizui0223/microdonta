...
flowchart TD
    ...
    R -. reference only .-> D["External owner: eco-genetic criticality"]
...
| Eco-genetic criticality | Independent criticality, fragmentation, and genetic-lag program | external repository `zuizui0223/eco-genetic-criticality` | Reference only; no local code, docs, examples, or tests |
...
- Do not present Campanula as empirical validation before channel-resolved data
  exist.
- Do not copy the external eco-genetic programme into microdonta or use
  application code as evidence for the RACH submission.
