...
This is why partial predictive coverage is distinct from both validated actionability and information limitation.
...
Only when every specification has the target unresolved, complete candidate coverage and positive validated information is a full cross-specification recommendation comparison defined. Then
...
If actionability itself differs across target-unresolved specifications, the correct result is `specification_sensitive_actionability`, not a forced common recommendation.
