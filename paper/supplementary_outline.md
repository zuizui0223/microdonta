...
- structure discovery;
- externally owned eco-genetic H1–H3 work;
- the attraction-trait incubator;
- Streamlit or tutorials as evidence.

They remain in repository history or their external owner repository and may be
promoted only through a later, explicit publication decision.
