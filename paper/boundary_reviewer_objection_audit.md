...
## 3. “The product non-identifiability is trivial.”
...
## 4. “The multiplicative model was chosen to manufacture the theorem.”
...
## 5. “Pollinator community service is a sum, not one product `W=FE`.”
...
## 6. “The `k-1-r` rule assumes every anchor is independent.”
...
## 7. “You are mixing channel anchors with proxy calibration anchors.”
...
## 8. “A change -> service -> dependency -> response chain is not necessarily multiplicative.”
...
## 9. “A relative proxy comparison cancels unknown calibration, so there is no problem.”
...
## 10. “Why should the calibration bound be believed?”
...
## 11. “You have only replaced one untestable stability assumption with a family of untestable assumptions.”
...
## 12. “The identified intervals for F and E can be reported independently.”
...
## 13. “Calling the errors perfectly negatively correlated is too statistical.”
...
## 14. “The 34% claim changes if I reverse the reference regime.”
...
## 15. “Sampling uncertainty is being confused with identification uncertainty.”
...
## 16. “N3 and N4 are unrelated endpoint statements.”
...
## 17. “One calibration anchor is insufficient if the system changes.”
...
## 18. “Two calibration anchors do not identify anything unless the true channel is measured.”
...
## 19. “Is this just causal-inference terminology applied to ecology?”

**Response:** no claim is made that latent-channel identification exhausts causal inference or mechanistic explanation. The target here is narrower: whether declared competing mechanisms or decompositions are observationally distinguishable under a specified observation map. Classical structural identifiability and partial identification are explicitly acknowledged, while ecological causal-mechanism work motivates why evidentiary distinctions matter.

**Pass criterion:** the manuscript never equates the present identified-set calculations with identification of every causal graph or intervention effect.

## 20. “What is the minimum publishable claim?”
...
- **Conceptual:** biological/mechanistic proximity and identification strength are different evidentiary properties; the worked theorems demonstrate the distinction without intrinsically ranking biological levels.
...
RACH, NOV, synthetic benchmark performance, Campanula causal claims, any claim that multiplicative decomposition is universal, and any intrinsic ranking of molecular versus field evidence are not required for this paper.
