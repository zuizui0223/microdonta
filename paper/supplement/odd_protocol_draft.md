> **Supplementary source only.** This ODD draft documents ABM families used for
> robustness and counterexample analyses. It is not part of the algebraic proof
> and is not a standalone primary-paper spine.
